...
const TermsConditions = () => {
  return (
    <div>
      <h2>Welcome to Com2kube</h2>
      <p>
        These terms and conditions outline the rules and regulations for the use of
        Com2kube's Website.
      </p>{" "}
      <br />
      <span style="text-transform: capitalize;"> Com2kube</span> is located at:
      <br />
      <address>
        <br />
      </address>
      <p>
        ...
        full. Do not continue to use Com2kube's website if you do not accept all of
      ...
      <p>
        ...
        Client and ourselves, or either the Client or ourselves. All terms refer to
        ...
        prevailing law of . Any use of the above terminology or other words in the
        singular, plural, capitalisation and/or he/she or they, are taken as
        interchangeable and therefore as referring to same.
      </p>
      <h2>Cookies</h2>
      <p>
        We employ the use of cookies. By using Com2kube's website you consent to the
        use of cookies in accordance with Com2kube's privacy policy.
      </p>
      <p>
      ...
      <h2>License</h2>
      <p>
        Unless otherwise stated, Com2kube and/or it's licensors own the intellectual
        property rights for all material on Com2kube. All intellectual property
        rights are reserved. You may view and/or print pages from https://com2kube.io
        for your own personal use subject to restrictions set in these terms and
        conditions.
      </p>
      <p>You must not:</p>
      <ol>
        <li>Republish material from https://com2kube.io</li>
        <li>Sell, rent or sub-license material from https://com2kube.io</li>
        <li>Reproduce, duplicate or copy material from https://com2kube.io</li>
      </ol>
      <p>
        Redistribute content from Com2kube (unless content is specifically made for
        redistribution).
      </p>
      ...
      <p>
        ...
        (for example, trade associations or other organizations representing
        inherently suspect types of business, such as work-at-home opportunities,
        shall not be allowed to link); (b)the organization does not have an
        unsatisfactory record with us; (c) the benefit to us from the visibility
        associated with the hyperlink outweighs the absence of Com2kube; and (d)
      ...
      <p>
        ...
        list of any URLs from which you intend to link to our Web site, and a list of
        the URL(s) on our site to which you would like to link. Allow 2-3 weeks for a
        response.
      </p>
      ...
      <p>
        No use of Com2kube's logo or other artwork will be allowed for linking absent
      ...
      <p>
        We reserve the right at any time and in its sole discretion to request that
      ...
      <p>
        ...
        generator. If you have any queries regarding any of our terms, please contact
        us.
      </p>
    </div>
  )
