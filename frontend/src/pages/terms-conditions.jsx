    ...
    <div className={classes.root}>
      <Container className={classes.body}>
        ...
        <p>
          ...
          in full. Do not continue to use Com2kube's website if you do not accept all
        ...
        <p>
          ...
          other means, for the express purpose of meeting the Client's needs in
        ...
        <h2>Cookies</h2>
        <p>
          We employ the use of cookies. By using Com2kube's website you consent to
          the use of cookies in accordance with Com2kube's privacy policy.
        </p>
        <p>
        ...
        <h2>License</h2>
        <p>
          Unless otherwise stated, Com2kube and/or it's licensors own the
          intellectual property rights for all material on Com2kube. All intellectual
          property rights are reserved. You may view and/or print pages from
          https://com2kube.io for your own personal use subject to restrictions set
        ...
        <p>
          ...
          visibility associated with the hyperlink outweighs the absence of Com2kube;
        ...
        <p>
          ...
          site, a list of any URLs from which you intend to link to our Web site, and
          a list of the URL(s) on our site to which you would like to link. Allow 2-3
        ...
        <p>
          No use of Com2kube's logo or other artwork will be allowed for linking
        ...
        <p>
          ...
          policy at any time. By continuing to link to our Web site, you agree to be
        ...
        <p>
          ...
          page on your Web site or within any context containing content or materials
